...
var commands = {
  'read': function(petsPath, node, file) {
  ...
  'create': function(petsPath, node, file) {
  ...
  'update': function(petsPath, node, file) {
  ...
  'destroy': function(petsPath, node, file) {
    let indexOfPetsData = process.argv[3];
...
if (commands[cmd] !== undefined) {
  commands[cmd](petsPath, node, file);
} else {
